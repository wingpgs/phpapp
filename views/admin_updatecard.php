...
?>
        ...
        <p class='h6 mb-3'>내용들을 수정하고 <span class='text-primary'>확인</span>을 누르세요...</p>
            <form class='was-validated' action='/admin/updateCardSubmit/<?=$map_id?>' method='post' autocomplete='off'>
                <div class='form-group'>
                    <input id='map_number' class='form-control' value='<?=$this->data['map']['map_number']?>'
                        name='number' type='text' placeholder='구역번호' required>
                    <div class='valid-feedback'>구역번호</div>
                    <div class='invalid-feedback'>구역번호을 입력하세요...</div>
                </div>
                <div class='form-group'>
                    <input id='map_name' class='form-control' value='<?=$this->data['map']['map_name']?>'
                        name='name' type='text' placeholder='구역명' required>
